...
def test_scancode_v4_license_bsd2clause(capsys):
    args = get_args('BSD-2-Clause', 'scancode-v4', ['test2/test-2.sh'])
    main(args)
...
def test_scancode_v4_license_x(capsys):
    args = get_args('X', 'scancode-v4', ['test2/test-2.sh'])
    main(args)
    captured = capsys.readouterr()
...
def test_scancode_v4_license_expand(capsys):
    args = get_args('GPL-2.0+', 'scancode-v4', ['test2/test-2.sh'])
    main(args)
    captured = capsys.readouterr()
...
def test_scancode_v4_good(capsys):
    args = get_args('GPL-3.0', 'scancode-v4', ['test2/test-2.sh'])
    main(args)
    captured = capsys.readouterr()
...
def test_scancode_v4_crholder(capsys):
    args = get_args('GPL-3.0', 'scancode-v4',
...
def test_scancode_v4_noinfo(capsys):
    args = get_args('GPL-3.0', 'scancode-v4',
...
def test_scancode_v4_nospdx(capsys):
    args = get_args('GPL-3.0', 'scancode-v4',
...
def test_scancode_v4_ignorepattern(capsys):
    args = get_args('X', 'scancode-v4',
                    ['curl-7.30.0.ermine/curl.ermine'],
...
def test_scancode_v4_ignorepattern2(capsys):
    args = get_args('X', 'scancode-v4',
                    ['curl-7.30.0.ermine/curl.ermine'],
                    sources=create_sources_file(
                        ['curl-7.30.0.ermine/curl.ermine',
...
def test_scancode_v4_ignorepattern2_wo_sources(capsys):
    args = get_args('X', 'scancode-v4',
                    ['curl-7.30.0.ermine/curl.ermine'],
                    ignorelicfiles='curl-7.30.0.ermine/another-file')
    main(args)
